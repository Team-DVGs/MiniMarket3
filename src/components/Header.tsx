                ...
                <div className="header-inner container-md">
                    <div className="header-inner-left">
                        <form action="https://www.google.com/search" method="GET" className="search-bar">
                            <input type="text" name="q" id = "search-product" placeholder="Search for product"/>
                            <button type="submit">
                                <img width="23" height="23" src="https://img.icons8.com/ios/50/search--v1.png" alt="search--v1"/>
                            </button>
                        </form>
                    </div>
                    <div className="header-inner-center">
                        <a href="index.html">
                            <img src={process.env.PUBLIC_URL + "/assets/img/brand-logo.png"} alt="Green Mart logo" width="100"/>
                        </a>
                    </div>
                    ...
                    <ul className="header-navigation">
                        ...
                        <li className="menu-item">
                            ...
                            <ul className="sub-menu sub-menu--mega">
                                ...
                                <li>
                                    <a href="#!">
                                        <img src="//boostify-nesst.myshopify.com/cdn/shop/files/mega-banner.jpg?v=1661418799&amp;width=540" width="508px" height="322px"/>
                                    </a>
                                </li>
                            </ul>
                        </li>
